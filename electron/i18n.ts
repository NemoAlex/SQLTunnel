...
const translations: Record<UiLocale, Record<string, string>> = {
  en: {},
  "zh-CN": {
    "SQLTunnel Settings": "SQLTunnel 设置", "Settings…": "设置…", "Edit": "编辑", "Window": "窗口",
  ...
  ja: {
    "SQLTunnel Settings": "SQLTunnel 設定", "Settings…": "設定…", "Edit": "編集", "Window": "ウインドウ",
  ...
  ko: {
    "SQLTunnel Settings": "SQLTunnel 설정", "Settings…": "설정…", "Edit": "편집", "Window": "윈도우",
  ...
  fr: {
    "SQLTunnel Settings": "Réglages de SQLTunnel", "Settings…": "Réglages…", "Edit": "Édition", "Window": "Fenêtre",
  ...
  de: {
    "SQLTunnel Settings": "SQLTunnel-Einstellungen", "Settings…": "Einstellungen…", "Edit": "Bearbeiten", "Window": "Fenster",
